...
En `egenskab` er en værdi, som du kan hente eller indstille (som at ændre indholdet af et HTML-element).

En `metode` er en handling, du kan udføre (som at tilføje eller slette et HTML-element).
