...
for(let image of arrImages) {
	...
	img.src = `../../../../assets/images/gallery/${image.file}`;
	document.getElementById('gallerywrapper').appendChild(img);
...
function showModal(objImage) {
	MODAL.children[0].style.backgroundImage = `url('../../../../assets/images/gallery/${objImage.file}')`
